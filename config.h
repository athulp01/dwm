...
static const Layout layouts[] = {
    ...
    {"[\\]", dwindle}, {"T", tile}, /* first entry is default */
...
static const char *dmenucmd[] = {
    ...
    col_gray3,   "-sb", "#3f4452", "-sf", "#61afef", NULL};
static const char *termcmd[] = {"alacritty", NULL};
static const char *unstrain[] = {"/bin/kill", "-SIGUSR1", "4828"};
static const char *firefoxcmd[] = {"firefox", NULL};
static const char *upvol[] = {"/usr/bin/pactl", "set-sink-volume", "2", "+5%",
                              NULL};
static const char *downvol[] = {"/usr/bin/pactl", "set-sink-volume", "2", "-5%",
                                NULL};
static const char *mutevol[] = {"/usr/bin/pactl", "set-sink-mute", "2",
                                "toggle", NULL};
static const char *upbright[] = {"/usr/bin/xbacklight", "-inc", "5"};
static const char *downbright[] = {"/usr/bin/xbacklight", "-dec", "5"};
static const char *screenshotcmd[] = {"/usr/bin/scrot",
                                      "/home/athul/screenshots/%d-%m-%Y-%R.png",
                                      "-e", "xclip -sel c -t image/png -i $f"};
